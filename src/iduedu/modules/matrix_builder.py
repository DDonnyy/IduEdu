...
def get_adj_matrix_gdf_to_gdf(
    ...
    if gdf_from.equals(gft_to):
        ...
        return adj_matrix
    closest_nodes_from = get_closest_nodes(gdf_from, to_nx_graph)
    closest_nodes_to = get_closest_nodes(gft_to, to_nx_graph)
    adj_matrix = get_dist_matrix(to_nx_graph, closest_nodes_from, closest_nodes_to, weight, dtype)
